...
def main() -> None:
    ...
    if not args.sweep:
        ...
        print(f"\n=== gate={args.gate} ===")
        print("\n-- positive files --")
        _, pos_records = report_counts(pos_files, band_names, "pos")
        print("\n-- negative files --")
        _, neg_records = report_counts(neg_files, band_names, "neg")
    ...
    print("\n=== baseline (gate off) ===")
    pos_baseline, pos_records = report_counts(pos_files, band_names, "pos")
    neg_baseline, neg_records = report_counts(neg_files, band_names, "neg")
